...
public class AboutDialog {
    ...
    public AboutDialog(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            builder.setMessage(Html.fromHtml(activity.getString(R.string.dialog_about_content), Html.FROM_HTML_MODE_LEGACY));
        } else {
            // No need for additional flag in fromHtml method if below Nougat
            builder.setMessage(Html.fromHtml(activity.getString(R.string.dialog_about_content)));
        }
